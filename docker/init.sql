...
INSERT INTO account (first_name, middle_name, last_name, street, city, state, zip_code, country, phone_number, date_of_birth, email, password, admin) VALUES
    ...
    ('Jane', 'B', 'Smith', '789 Oak Ave', 'Chicago', 'IL', '01601', 'USA', '5553456789', '1992-08-22', 'jane.smith@example.com', '$2a$10$6B.Ga3IPj/Ahk6CEi0ZBBeJtBK3xbNFOBNYgQpbn6j8H8UGuv5XQa', FALSE),
...
INSERT INTO claim (description, claim_date, claim_status, policy_id) VALUES
    -- Admin user claims (policies 1,2,3)
    ('Minor fender bender on highway', '2024-03-15', 'APPROVED', 1),
    ('Water damage from burst pipe', '2024-04-20', 'IN_PROGRESS', 2),
    -- John Doe claims (policies 4,5,6)
    ('Rear-end collision at intersection', '2024-05-10', 'APPROVED', 4),
    ('Roof damage from hailstorm', '2024-06-15', 'SUBMITTED', 5),
    -- Jane Smith claims (policies 7,8)
    ('Annual health checkup', '2024-07-01', 'APPROVED', 8),
    -- Bob Johnson claims (policies 9,10,11)
    ('Windshield crack from road debris', '2024-08-05', 'IN_PROGRESS', 9),
    ('Emergency room visit', '2024-09-10', 'APPROVED', 11);
