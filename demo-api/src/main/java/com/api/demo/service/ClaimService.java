...
public interface ClaimService {
	 ...
	 *
	 * @param claimId:
	 *            take claim id by user and check this id exist in database or not
	 *            if not exist in database then throw a particular exception if exit
	 ...
	 *            in database then fetch and store a particular variable
	 *
	 *            after all opration swap all claim parameter data in featch claim
	 *            data. after save in database
	 ...
	 *            take claim id by user and check this id exist in database or not
	 *            if not exist in database then throw a particular exception if exit
	 *            in database then fetch and store a particular variable after this
	 *            delete all info in database
